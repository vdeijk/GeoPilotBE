...
class Program
{
    ...
    {
        var csvPath = @"C:\Users\Gebruiker\repos\Invenna\BE\BE-Restructured\BE.Data\Data\geographicaldata-fixed.csv";

        var options = new DbContextOptionsBuilder<GeographicalDataContext>()
            .UseSqlite("Data Source=C:/Users/Gebruiker/repos/Invenna/BE/BE-Restructured/BE.Data/Data/geodata.db")
            .Options;
